...
switch ($method) {
    case 'GET':
        ...
        break;
        case 'POST':
        // Verificar si se proporcionan los parámetros necesarios para crear un nuevo usuario o hacer login
        if (isset($input['nombre'], $input['contrasena'], $input['carrito'], $input['monedero'], $input['foto'], $input['telefono'], $input['ubicacion'], $input['correo'], $input['tipo'])) {
            ...
            if ($result) {
                ...
                Sesion::escribir('usuario', [
                    'id' => $usuarioCreado->id_usuario,  // Acceso a las propiedades del objeto Usuario
                    'nombre' => $usuarioCreado->nombre,  // Acceso a las propiedades del objeto Usuario
                    'tipo' => $usuarioCreado->tipo,      // Acceso a las propiedades del objeto Usuario
                ]);
        ...
        elseif (isset($input['nombre'], $input['contrasena'])) {
            ...
            if ($usuario) {
                ...
                Sesion::iniciar();
                Sesion::escribir('usuario', [
                    'nombre' => $usuario->nombre,  // Acceso a la propiedad 'nombre' del objeto Usuario
                    'tipo' => $usuario->tipo,      // Acceso a la propiedad 'tipo' del objeto Usuario
                ]);
